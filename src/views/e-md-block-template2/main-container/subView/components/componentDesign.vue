        ...
        <el-form :model="compData" :rules="formRules" ref="compFormRef" label-width="100">
            <el-form-item label="类型" prop="type">
                <el-select v-model="compData.type" placeholder="选择类型">
                    <el-option
                        v-for="(item, k) in componentTypes"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value"
                    />
            ...
            <el-form-item
                label="得分"
                prop="score"
                v-show="compData.needCalculate"
            >
                <el-input-number
                    v-model="compData.score"
                    :min="0"
                ></el-input-number>
            </el-form-item>
            ...
            <template v-if="props.compData.type == 'TEXT'">
                ...
                >
                    <contentEdit
                        v-model="compData.payload.content"
                    ></contentEdit>
                </el-form-item>
            </template>
            ...
            <template v-if="compData.type == 'VIDEO'">
                ...
                >
                    ...
                    <div>
                        ...
                        <el-icon
                            class="ml-4"
                            v-show="compData.payload.video.filename"
                            @click="deleteVideo"
                        >
                            <Delete />
                        </el-icon>
                ...
                <el-form-item
                    label="视频描述"
                    prop="payload.video.description"
                    :rules="[
                        {
                            required: true,
                            message: '请输入视频描述',
                ...
                >
                    <el-input
                        v-model="compData.payload.video.description"
                    ></el-input>
                </el-form-item>
            </template>
            ...
            <template v-if="compData.type === 'GROUP'">
                <el-form-item label="限制人数" prop="group.limitNum">
                    <el-input-number
                        v-model="compData.payload.group.limitNum"
                        min="1"
                    >
                    </el-input-number>
                </el-form-item>
            ...
            <template v-if="compData.type == 'CHOICE'">
                <el-form-item label="题目：" prop="payload.question.question">
                    <el-input
                        v-model="compData.payload.question.question"
                        type="textarea"
                ...
                <el-form-item label="选项：" prop="payload.question.options">
                    ...
                    <div class="flex flex-col">
                        <el-radio-group
                            v-model="compData.payload.question.answer"
                        >
                            <el-radio
                                v-for="item in compData.payload.question
                                    .options"
                                :label="item.label"
                            >
                ...
                <el-form-item label="解析：">
                    <el-input
                        v-model="compData.payload.question.analysis"
                        type="textarea"
                        :autosize="{ minRows: 4, maxRows: 10 }"
                        placeholder="输入题目解析 支持markdown"
                    ></el-input>
                </el-form-item>
                <el-form-item label="难度：" prop="payload.question.difficulty">
                    <el-rate
                        v-model="compData.payload.question.difficulty"
                        :min="1"
                        :max="10"
                    />
                </el-form-item>
            ...
            <template v-if="compData.type == 'MULTIPLECHOICE'">
                ...
                <el-form-item label="选项：" prop="payload.question.options">
                    ...
                    <el-checkbox-group
                        v-model="compData.payload.question.answerOption"
                    >
                        <el-checkbox
                            v-for="item in compData.payload.question.options"
                            :label="item.label"
                        >
                            <div class="flex items-center">
                                <span class="mr-2">{{ item.label }}.</span>
            ...
            <template v-if="['QA', 'CIRCUIT'].includes(compData.type)">
                ...
                <el-form-item label="错误引导：">
                    <el-input
                        v-model="compData.payload.question.hintWhenWrong"
                        type="textarea"
                        :autosize="{ minRows: 4, maxRows: 10 }"
                        placeholder="输入题目错误指引 支持markdown"
                    ></el-input>
                </el-form-item>
                <el-form-item label="难度：" prop="difficulty">
                    <el-rate
            ...
            <template v-if="compData.type == 'RANGE'">
                ...
                <el-form-item label="最小值：" prop="payload.question.min">
                    <el-input-number
                        v-model="compData.payload.question.min"
                        :max="compData.payload.question.max"
                    ></el-input-number>
                </el-form-item>
                <el-form-item label="最大值：" prop="payload.question.max">
                    <el-input-number
                        v-model="compData.payload.question.max"
                        :min="compData.payload.question.min"
                    ></el-input-number>
                </el-form-item>
                <el-form-item label="解析：" prop="payload.question.analysis">
                    <el-input
