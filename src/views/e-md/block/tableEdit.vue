                            ...
                            <div class="cell" v-if="ConfData.tableData[rowIndex - 1][colIndex - 1]">
                                ...
                                <div class="cell-ref"
                                    ...
                                    <el-button size="small" :icon="Setting"
                                        ...
                                        @click="setItemRef(rowIndex - 1, colIndex - 1, ConfData.tableData[rowIndex - 1][colIndex - 1].id)">
                                    </el-button>
                                </div>
                            </div>
                        </td>
            ...
            <div class="value-reference-main">
                <div v-if="seclectItem.row != null"
                    ...
                    <el-form-item label="参考值：">
                        <el-input size="small"
                            v-model="ReferenceData[seclectItem.row][seclectItem.col].value"></el-input>
                    </el-form-item>
                    <el-form-item label="最小值：">
                        <el-input-number size="small"
                            v-model="ReferenceData[seclectItem.row][seclectItem.col].minVal"></el-input-number>
                    </el-form-item>
                    <el-form-item label="最大值：">
                        <el-input-number size="small"
                            v-model="ReferenceData[seclectItem.row][seclectItem.col].maxVal"></el-input-number>
                    </el-form-item>
                </div>
                <div style="flex:1">
...
const addRow = () => {
    ...
    ReferenceData.value.push(newRefRow)
...
const addCol = () => {
    for (let row = 0; row < ConfData.value.rowNum; row++) {
        ...
        ReferenceData.value[row].push(JSON.parse(JSON.stringify(refData)))
    }
...
const setItemRef = (row: number, col: number, id: string) => {
