...
const loadChartOption = () => {
    ...
    if (xIsNaN.includes(true)) {
        ...
        dataTemplate.value.chartData.xmax = Math.max.apply(null, dataTemplate.value.chartData.x);
        dataTemplate.value.chartData.xmin = Math.min.apply(null, dataTemplate.value.chartData.x);
    }
    ...
    if (yIsNaN.includes(true)) {
        ...
        dataTemplate.value.chartData.ymax = Math.max.apply(null, dataTemplate.value.chartData.y)
        dataTemplate.value.chartData.ymin = Math.min.apply(null, dataTemplate.value.chartData.y)
    }
