    ...
    <div>
        <div class="mb-4">
            <div class="flex items-center mb-2">
                <span
                    class="w-8 h-8 rounded-full bg-green-100 text-green-600 flex items-center justify-center font-bold mr-3">
                    {{ index + 1 }}
                </span>
        ...
        <div v-if="question.options" class="space-y-2 mb-4">
            <div v-for="item in question.options">
                <div v-if="splitByComma(question.answer).includes(item.label) && splitByComma(question.response).includes(item.label)"
                ...
                <div v-else-if="splitByComma(question.answer).includes(item.label) && !splitByComma(question.response).includes(item.label)"
...
import { splitByComma } from '@/utils/util'
