<template>
  <div v-for="(compItem, k) in compList" :key="k" :class="k != 0 ? 'mt-8' : ''">
    <choice :index="k + 1" v-if="compItem.type == 'CHOICE' && compItem.needCalculate" :comp="compItem">
    </choice>
    <multipleChoice :index="k + 1" v-if="compItem.type == 'MULTIPLECHOICE' && compItem.needCalculate" :comp="compItem">
    </multipleChoice>
  </div>
</template>
