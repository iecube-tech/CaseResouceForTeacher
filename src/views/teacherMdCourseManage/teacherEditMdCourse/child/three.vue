    ...
    <div id="pane-fiveth" class="pane" key="4">
        ...
        <div style="margin: 30px 0px;">
            <el-card style="min-height:280px;" shadow="never">
                ...
                <mdExperimentalDesignd :key="Date.now().toString()" :course="course" :isEdit="isEdit"
...
import mdExperimentalDesignd from "@/views/teacherMdCourseManage/teacherEditMdCourse/child/threeChild/mdExperimentalDesign.vue";
...
const addTaskTemplateNext = () => {
    ...
    UpMdCompleton(CaseId.value, 2).then(res => {
        if (res.state == 200) {
